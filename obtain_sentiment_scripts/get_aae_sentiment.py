"""
Script to obtain sentiment classifications for AAE tweets.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Analyze sentiment for AAE tweets")
    ...
    output_df = pd.DataFrame({
        'text': [s['text'] for s in all_sentiments],
