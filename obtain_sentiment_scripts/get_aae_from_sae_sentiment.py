"""
Script to obtain sentiment classifications for AAE texts translated from SAE.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Analyze sentiment for AAE translations from SAE")
